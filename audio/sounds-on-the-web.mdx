...
<Tip>
Sound bridges the gap between action and response in a way that visual feedback alone cannot. A notification that chimes is present in your room, not just on your display.
</Tip>
...
I'm not saying you should turn your app into a game, but games have nailed the balance of informative, emotional, and non-intrusive sound. They use sound to reward actions, signal errors, and provide context without overwhelming the player.
...
- Confirmations for major actions like payments or uploads
...
The sound should match the weight of the action and be informative rather than punishing.
